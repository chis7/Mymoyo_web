LOCAL_KNOWLEDGE = [
    {
        'title': 'Using MyMoyo',
        'keywords': {'portal', 'mymoyo', 'profile', 'dashboard', 'navigate', 'navigation', 'account'},
        'links': {'home', 'dashboard', 'profile'},
        'answer': (
            'MyMoyo means "my life." Use the portal to view your profile, appointments, '
    ...
    },
    {
        ...
        'answer': (
            'MyMoyo uses roles to show the right tools to each person. Clients see their own care '
    ...
    },
    {
        ...
        'links': {'profile'},
        'answer': (
            'Keep your password private and log out on shared devices. MyMoyo limits access by role, '
...
LOCAL_FALLBACK = (
    'I can help offline with MyMoyo navigation, appointments, clinic search, roles, self-testing, '
...
def get_local_reply(message):
    ...
    return f"{best_item['answer']}\n\nOffline guide: this answer uses local MyMoyo education content."
