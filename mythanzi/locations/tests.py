...
class FacilityMapTests(TestCase):
    ...
    def test_authenticated_user_can_view_facility_map(self):
        ...
        self.assertContains(response, 'selected-facility-pin')
        self.assertContains(response, 'const isSelected = getFacilityKey(facility) === selectedFacilityKey')
        self.assertContains(response, "html: '<div class=\"selected-facility-pin\"")
